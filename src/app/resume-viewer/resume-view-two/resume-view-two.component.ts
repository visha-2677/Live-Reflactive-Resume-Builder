...
@Component({
  selector: 'app-resume-view-two',
  standalone: true,
  imports: [DatePipe],
  templateUrl: './resume-view-two.component.html',
  styleUrl: './resume-view-two.component.scss'
})
export class ResumeViewTwoComponent {
  ...
  ngOnInit(): void {
    ...
    this.resumeDataService.resumeDataAddMore$.subscribe((data:any) => {
